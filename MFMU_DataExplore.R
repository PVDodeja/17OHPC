...
plot_quantile<-function(data_for_plot, biom, conc)
  ...
  geom_point()+
    scale_y_continuous(limits=c(0,20), n.breaks=18)
     p1+ geom_quantile(quantile=q5, colour = "blue", linewidth =1, linetype="dashed" ,alpha = 0.5)+theme_cowplot()
}
...
plot_quantile(d1_test, GATEST2, OHP2)
 ...
 plot_quantile(d1_test, CRP1, CAP1)
#CRP and OHP
